...
//               <Card
//                 key={service.id}
//                 className="relative group hover:shadow-xl hover:scale-[1.02] hover:bg-[#FFCE12]/80 transition-all duration-300 border-border/50 hover:border-primary/30 break-inside-avoid mb-8 transform"
//               >
//                 {service.badge && (
