...
//       <nav className="w-[95%] md:w-[90%] max-w-7xl bg-white/70 backdrop-blur-xl border border-gray-200 rounded-full shadow-lg px-6 py-4">
...
//                     isActive
//                       ? "text-black"
//                       : "text-gray-700 hover:text-[#FFCE12]"
//                   }`}
//                 >
//                   {label}
...
//               <Facebook className="w-6 h-6 text-gray-600 hover:text-blue-500 hover:scale-110 transition transform duration-300" />
//             </Link>
//             <Link href="https://www.instagram.com" target="_blank">
//               <Instagram className="w-6 h-6 text-gray-600 hover:text-blue-500 hover:scale-110 transition transform duration-300" />
//             </Link>
//             <Link href="https://www.linkedin.com" target="_blank">
//               <Linkedin className="w-6 h-6 text-gray-600 hover:text-blue-500 hover:scale-110 transition transform duration-300" />
//             </Link>
//           </div>
